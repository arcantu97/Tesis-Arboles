...
% Definiendo campos %
%%%%%%%%%%%%%%%%%%%%%
\def\titulo{Análisis de recorridos por drones supervisados sobre bosques}
...
\def\orientacion{}
\def\fecha{Agosto 2020} % Coloca el mes con mayúscula inicial

\def\asesor{Dra. Satu Elisa Schaeffer}
\def\revisorA{Dra. Sara Elena Garza Villareal}
