...
%\paragraph{•}  scaling/normalization

\chapter{Estado del arte}
En este capítulo se explica la relación con investigaciones de otros autores, la importancia-relación de la visión computacional y los inventarios forestales en nuestra investigación así como los apartados que se desarrollan en la investigación.
