...
\begin{figure}
 \centering
 \subfloat[Ejemplo de muestras de la zona de Cilantrillo]{\includegraphics[scale=0.6]{grid_Cilantrillo}}\par
\subfloat[[Ejemplo de muestras de la zona de Trinidad]{\includegraphics[scale=0.6]{grid_Trinidad}}
\end{figure}
