...
\begin{figure}
 \centering
 \subfloat[Ejemplo de muestras de la zona de Cilantrillo]{\includegraphics[scale=0.175]{grid_Cilantrillo}}\par
\subfloat[Ejemplo de muestras de la zona de Trinidad]{\includegraphics[scale=0.175]{grid_Trinidad}}
\end{figure}
...
\subsection{Umbralización}
En este experimento se prueban 3 combinaciones distintas por cada clase (0.05\%, 0.25\% y 0.50\%), generando 27 posibles para cada especie de arbóles, esto con el fin de determinar umbral con mejor desempeño y pueda determinar un umbral eficiente otros experimentos para obtener un mejor resultado en la solución propuesta. Este experimento sirve para determinar también, el umbral que servirá como base para experimentos que tengan que utilizar un nivel de umbral eficiente determinado a partir de este.

\begin{figure}[h!]
  \centering
\begin{tabular}{@{}ccc@{}}
\subfloat[0.05\% de píxeles admitidos]{\includegraphics[width=0.30\textwidth]{results_umbral005}} & 
\subfloat[0.25\% de píxeles admitidos]{\includegraphics[width=0.30\textwidth]{results_umbral025}} &
\subfloat[0.50\% de píxeles admitidos]{\includegraphics[width=0.30\textwidth]{results_umbral050}}
  \end{tabular}
  \caption[Comparación de anotaciones]{Comparación de anotaciones hechas por el aprendizaje máquina y expertos.}
  \label{Comparación de anotaciones}
\end{figure}
